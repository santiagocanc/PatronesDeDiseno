 ...
 * @author Weriko
 */
public class BlisterPastilla implements IProducto {
    ...
    public String toString() {
        return "BlisterPastilla{" + "precio=" + precio + ", volumen=" + volumen + ", cantidad=" + cantidad + ", material=" + material + ", etiqueta=" + etiqueta + ", nombre=" + nombre + ", uso=" + uso + ", restricciones=" + restricciones + ", empresa=" + empresa + ", tipo=" + tipo + '}';
    }

  

    
    private String tipo = "capsula";
